...
export const en: Record<MessageKey, string> = {
  ...
  'prot.archiveIntro': 'Signed checklists, to read or print and file.',
  'prot.none': 'No signed checklists in this period.',
  'prot.print': 'Print',
  'prot.open': 'Open record',
  'prot.back': 'Back to the archive',
  'prot.notSigned': 'This list is not signed yet. The record shows it as it stands now.',
  'prot.versionChanged': 'The form has changed since this list was performed (version {run} then, version {now} now). The wording below is the current form.',
  'prot.answeredOf': '{answered} of {total} points answered',
  'prot.answer': 'Answer',
  'prot.note': 'Note',
  'prot.blank': '—',
  'prot.photos': 'Photos',
  'prot.photoCount': '{count} photo(s)',
  'prot.signatures': 'Performed by',
  'prot.signedAt': 'Signed',
  'prot.noSignatures': 'Not signed.',
  'prot.control': 'After-control',
  'prot.controlPending': 'Not reviewed yet.',
  'prot.printedAt': 'Printed {at}',
  'prot.filedBy': 'Record from GM Checklista. The original is held in the system.',
};
