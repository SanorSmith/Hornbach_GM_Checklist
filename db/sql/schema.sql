...
-- ===== db/migrations/0006_assignments.sql =====
...
ALTER TABLE "assignments" ADD CONSTRAINT "assignments_store_id_stores_id_fk" FOREIGN KEY ("store_id") REFERENCES "public"."stores"("id") ON DELETE no action ON UPDATE no action;
ALTER TABLE "assignments" ADD CONSTRAINT "assignments_assigned_to_users_id_fk" FOREIGN KEY ("assigned_to") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;
...
CREATE UNIQUE INDEX "assignment_unique" ON "assignments" USING btree ("store_id","business_date","template_code","slot");
